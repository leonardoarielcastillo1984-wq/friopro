  ...
  app.get('/public/:token', async (req: FastifyRequest, reply: FastifyReply) => {
    ...
    return reply.send({
      access: {
        ...
        canCreateNonConformities: access.canCreateNonConformities,
        canViewNcrOwn: access.canViewNcrOwn,
        canViewNcrScope: access.canViewNcrScope,
        canEditNcrDraft: access.canEditNcrDraft,
        canCorrectNcrReturned: access.canCorrectNcrReturned,
        canDownloadNcrPdf: access.canDownloadNcrPdf,
