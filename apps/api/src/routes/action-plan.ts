...
const createSchema = z.object({
  ...
  findingDescription: z.string().nullable().optional(),
  ...
  validatedRootCause: z.string().nullable().optional(),
  ...
  detectedBy: z.string().nullable().optional(),
  preventiveAction: z.string().nullable().optional(),
  processChanges: z.string().nullable().optional(),
  documentationChanges: z.string().nullable().optional(),
...
const updateSchema = createSchema.extend({
  ...
  effectivenessMethod: z.string().nullable().optional(),
  effectivenessResult: z.string().nullable().optional(),
