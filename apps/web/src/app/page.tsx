...
const FEATURES = [
  {
    ...
    description: 'Acceso a SGI 360, SHE 360 y Audit360 en una única plataforma centralizada'
  },
  {
    icon: '🔒',
...
export default function Home() {
  ...
  const handleSubmitRegistration = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/register-company', {
        method: 'POST',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white relative overflow-hidden reveal-on-scroll">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: 'BÁSICO', price: '$99', features: ['4 módulos', '10 usuarios', 'Email soporte', 'Actualizaciones incluidas'], highlight: false },
              { name: 'PROFESIONAL', price: '$299', features: ['12 módulos', '50 usuarios', 'Soporte prioritario', 'API access', 'Integraciones'], highlight: true },
              { name: 'PREMIUM', price: '$799', features: ['15 módulos', 'Usuarios ilimitados', 'Soporte 24/7', 'IA Auditora', 'Customización'] }
            ].map((plan, idx) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="hover:text-blue-400">SHE 360</a></li>
