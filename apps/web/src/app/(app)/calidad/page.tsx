...
import { AlertTriangle, Siren, RefreshCw, ClipboardList } from 'lucide-react';
    ...
    <Suspense>
      <div className="space-y-2">
        <div>
          ...
          <p className="mt-1 text-sm text-neutral-500">No conformidades, plan de acción, incidentes y gestión de cambios — ISO §8, §10</p>
        </div>
        <PageTabs tabs={TABS}>
          {(active) => (
            <>
