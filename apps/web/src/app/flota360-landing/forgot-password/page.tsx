...
export default function Flota360ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      const res = await fetch("/api/flota360/auth/forgot-password", {
        method: "POST",
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {sent ? (
            <div className="text-center py-6">
              ...
              <Link href="/flota360-landing" className="text-blue-600 hover:text-blue-700 text-sm font-semibold inline-flex items-center gap-1">
