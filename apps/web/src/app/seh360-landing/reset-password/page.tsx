...
import { ShieldCheck, ArrowLeft, KeyRound, CheckCircle, Eye, EyeOff } from "lucide-react";
...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      const res = await fetch("/api/seh360/auth/reset-password", {
        method: "POST",
      ...
      setDone(true);
      setTimeout(() => router.push("/seh360-landing"), 3000);
    } catch (err: any) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Seguridad e Higiene Laboral</p>
            </div>
          </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-emerald-500 to-green-500 text-white py-2.5 rounded-lg text-sm font-semibold hover:from-emerald-600 hover:to-green-600 transition-all disabled:opacity-60"
                >
              ...
              <div className="mt-6 text-center">
                <Link href="/seh360-landing" className="text-slate-400 hover:text-slate-600 text-xs flex items-center justify-center gap-1">
...
export default function Seh360ResetPassword() {
  return (
    <Suspense>
      <ResetPasswordForm />
    </Suspense>
